		...
		modalBody: `
			<div class="row justify-content-center pt-4">
				<div class="col-12 col-md-11 col-lg-10 creditos-curso">
					...
					<p class="mb-5">Análise de Situação de Saúde</p>
					...
					<div class="mb-5">
						...
						<p class="mb-1">Dimas Monteiro</p>
						<p class="small text-muted"><em>UX/UI e Webdesigner</em></p>
					...
					<div class="mb-5">
						<p class="creditos-modulo mb-2 mt-4">Módulo 1: Análise de Situação de Saúde</p>
						<p class="mb-1">Vânia Rocha</p>
						<p class="small text-muted mb-3"><em>[Aulas 1 e 2]</em></p>
						<p class="mb-1">Jessica Muzy</p>
						<p class="small text-muted mb-3"><em>[Aulas 3 e 4 ]</em></p>
					</div>
				</div>
			</div>
		`,
